...
export default function InputComp(props) {
    ...
    return (
        <motion.div className={styles.inputContent} initial="hidden" animate="visible"  variants={{
            ...
            <input className={styles.input} type='text' maxLength={props.size} placeholder={props.placeholder} value={props.inputValue} required onKeyDown={e => keyHandler(e)} onChange={ (e) => {
