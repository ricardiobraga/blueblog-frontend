  ...
  return (
    <section id='sign' className={styles.signupContainer} >
      ...
      visible: {
        ...
        <h1 className={styles.title}>Welcome to The Blue Blog!</h1>
        <InputComp title="Please enter your username" placeholder="John doe" size={20} setInputValue={setInput} inputValue={input}  handleInput={handleInput} setLink={setLink} />
