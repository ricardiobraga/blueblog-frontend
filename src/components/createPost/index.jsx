...
export default function CreatePost(props) {
    ...
    return (
        ...
        <form className={styles.createPostContent}>
            <h1 className={styles.title}>What’s on your mind?</h1>
            <InputComp title="Title" setInputValue={setTitle} inputValue={title} size={45} handleInput={handleInput} placeholder="Hello world" />
